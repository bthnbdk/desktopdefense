...
export const WavePreview: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-0 right-0 w-[calc(100%-180px)] h-[32px] px-6 flex items-center justify-start pointer-events-auto overflow-hidden panel-glass border-t border-[var(--border-color)]">
